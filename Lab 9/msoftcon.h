...
extern void draw_rectangle(int left, int top, int right, int bottom);                    
extern void draw_circle(int x, int y, int rad);
extern void draw_line(int x1, int y1, int x2, int y2);
extern void draw_pyramid(int x1, int y1, int height);
extern void set_fill_style(fstyle);
extern void set_fill_style(char);
#endif /* _INC_WCONSOLE */ 
